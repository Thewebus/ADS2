...
class UploadHandler
{
    ...
    function __construct($doc_cat_id_n,  $options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/'.$doc_cat_id_n.'/',
            'upload_url' => $this->get_full_url().'/'.$doc_cat_id_n.'/',
            'user_dirs' => false,
            'mkdir_mode' => 7777,
            'param_name' => 'files',
            ...
            'accept_file_types' => '/\.(doc|docx|xls|xlsx|xml|mpp|ppt|pptx|vsd|sql|pdf|zip|jpe?g|png)$/i',
