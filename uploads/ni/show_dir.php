...
?>
   <tr>
      ...
      <td width="480">
<?php 
	$ext_fichier 	= substr($file,-3,3);
	if(strlen($file) > 15)
		$nom_fichier	= substr(str_replace(" ","_",$file),0,15).'~.'.$ext_fichier;
		
?>
         <div id="ni_content">
            <p><a <?php echo 'id="ni_id_'.$num.'"'; ?> href="uploads/ni/files/<?php echo $file;?>"><?php echo $nom_fichier; ?></a> </p>
         </div>
      </td>
   </tr>
   <?php	
